...
import com.netposa.component.jq.di.component.DaggerFaceDeployComponent;
...
import com.netposa.component.jq.mvp.presenter.FaceDeployPresenter;
...
public class FaceDeployFragment extends BaseFragment<FaceDeployPresenter> implements
        FaceDeployContract.View,
    ...
    public static FaceDeployFragment newInstance() {
        Log.d("FaceDeployFragment","newInstance");
        FaceDeployFragment fragment = new FaceDeployFragment();
        return fragment;
    }

    @Override
    public void setupFragmentComponent(@NonNull AppComponent appComponent) {
        DaggerFaceDeployComponent //如找不到该类,请编译一下项目
                .builder()
                .appComponent(appComponent)
                .faceDeployModule(new FaceDeployModule(this, getActivity()))
                .build()
                .inject(this);
    }
    ...
    public void initView(@Nullable Bundle savedInstanceState) {
        ...
        mTvNoContent.setText(R.string.receive_no_message_deploy_face);
        //recyclerview
        ...
        mRequest.setScore(0);//设置为0服务器可能返回很多脏数据
        mRequest.setPageSize(PAGE_SIZE_DEFAULT);
        mRequest.setAlarmType(String.valueOf(TYPE_FACE_DEPLOY));
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (resultCode == FACE_TO_DETAIL_RESULTCODE && data != null) {
            Log.i(TAG, "face onActivityResult");
            mPresenter.getlistAlarmInfo();
        }
    }
}
