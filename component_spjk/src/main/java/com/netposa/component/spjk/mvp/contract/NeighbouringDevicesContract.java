...
public interface NeighbouringDevicesContract {
    //对于经常使用的关于UI的方法可以定义到IView中,如显示隐藏进度条,和显示文字消息
    interface View extends IView {
        void onGetNeighbouringDeviceSuccess(List<OneKilometerCamerasResponseEntity> reponse);
    ...
    interface Model extends IModel {
        Observable<List<OneKilometerCamerasResponseEntity>> getNeighbouringDevice(OneKilometerCamerasRequestEntity okcRequestEntity);
    }
}
