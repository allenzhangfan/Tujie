...
import com.netposa.component.spjk.mvp.model.entity.FollowDevicesEntity;
 ...
 */
public class FollowDevicesAdapter extends BaseQuickAdapter<SpjkCollectionDeviceEntiry, BaseViewHolder> {

    @Inject
    Context mContext;

    @Inject
    public FollowDevicesAdapter(@Nullable List<SpjkCollectionDeviceEntiry> data) {
        super(R.layout.item_follow_devices, data);
    }

    @Override
    protected void convert(BaseViewHolder helper, SpjkCollectionDeviceEntiry item) {
