...
class ActivityLifecycleCallbacksImpl implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityStarted(Activity activity) {
        Log.w(activity.getClass().getSimpleName() + " - onActivityStarted");
    ...
    public void onActivityResumed(Activity activity) {
        Log.w(activity.getClass().getSimpleName() + " - onActivityResumed");
    }

    @Override
    public void onActivityPaused(Activity activity) {
        Log.w(activity.getClass().getSimpleName() + " - onActivityPaused");
    }

    @Override
    public void onActivityStopped(Activity activity) {
        Log.w(activity.getClass().getSimpleName() + " - onActivityStopped");
    }

    @Override
    public void onActivitySaveInstanceState(Activity activity, Bundle outState) {
        Log.w(activity.getClass().getSimpleName() + " - onActivitySaveInstanceState");
    }

    @Override
    public void onActivityDestroyed(Activity activity) {
        Log.w(activity.getClass().getSimpleName() + " - onActivityDestroyed");
