...
import com.netposa.common.interceptor.HeaderInterceptor;
...
//                        Log.i("printJsonRequest:" + bodyString);
//                    }
//
//                    @Override
//                    public void printFileRequest(Request request) {
//                        Log.i("printFileRequest:" + request.url().toString());
//                    }
//
//                    @Override
...
//                    RetrofitUrlManager.getInstance().with(okhttpBuilder);
    ...
    public void injectAppLifecycle(Context context, List<AppLifecycles> lifecycles) {
        ...
        lifecycles.add(new Log4jAppLifecycle());
    }
