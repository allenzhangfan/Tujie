...
import com.jess.arms.di.scope.TypeActivityLifecycle;
import com.jess.arms.di.scope.TypeActivityLifecycleForRxLifecycle;
...
public abstract class AppModule {
    ...
    @Binds
    @TypeActivityLifecycle
    abstract Application.ActivityLifecycleCallbacks bindActivityLifecycle(ActivityLifecycle activityLifecycle);

    @Binds
    @TypeActivityLifecycleForRxLifecycle
